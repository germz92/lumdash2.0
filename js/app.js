...
function navigate(page, id) {
  ...
  const needsId = !['events', 'dashboard', 'login', 'register', 'users', 'crew-planner', 'crew-calendar', 'inventory-management', 'my-tasks', 'call-times', 'reimbursements', 'post-production', 'settings', 'feedback', 'video-portal'].includes(page);
...
function loadPageCSS(page) {
  ...
  switch (page) {
    ...
    case 'feedback': cssFile = 'css/feedback.css'; break;
    case 'video-portal': cssFile = 'css/video-portal.css'; break;
...
function restoreLastPageState() {
  try {
    ...
    const needsId = !['events', 'dashboard', 'login', 'register', 'users', 'crew-planner', 'crew-calendar', 'inventory-management', 'my-tasks', 'call-times', 'reimbursements', 'post-production', 'settings', 'feedback', 'video-portal'].includes(pageState.page);
