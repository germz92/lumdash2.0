...
function navigate(page, id) {
  ...
  const needsId = !['events', 'dashboard', 'login', 'register', 'users', 'crew-planner', 'crew-calendar', 'inventory-management', 'my-tasks', 'call-times', 'reimbursements', 'post-production', 'settings', 'feedback'].includes(page);
...
function restoreLastPageState() {
  try {
    ...
    const needsId = !['events', 'dashboard', 'login', 'register', 'users', 'crew-planner', 'crew-calendar', 'inventory-management', 'my-tasks', 'call-times', 'reimbursements', 'post-production', 'settings', 'feedback'].includes(pageState.page);
